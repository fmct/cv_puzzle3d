...
function recSubdivisionCentroid( v1, v2, v3, 
	...
	if( recursionDepth == 0 ) {
		...
		var midv = computeCentroid(v1, v2, v3);
        
        // Colors are also averaged

        var cv = computeCentroid( c1, c2, c3 );
        
        // 4 recursive calls 

        recSubdivisionCentroid( v1, v2, midv, c1, c2, cv,
                                coordsArray, colorsArray, recursionDepth - 1 );

        recSubdivisionCentroid( v2, v3, midv, c2, c3, cv,
                                coordsArray, colorsArray, recursionDepth - 1 );


        recSubdivisionCentroid( v3, v1, midv, c3, c1, cv,
                                coordsArray, colorsArray, recursionDepth - 1 );
    }
}
